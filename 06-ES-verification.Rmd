...
![306.6.C.2 from National Instruction](_book/ES_verification_instruction.JPG)
...
![](_book/ES_verification_ecosite_level_output.JPG)
...
![](_book/ES_verification_site_level.JPG)
...
Run "SSRO_Southwest > Sites by ecositeid with %" (not listed as ready for use) using an appropriate pattern for Ecological Site ID (e.g., %018X% for MLRA18)
